...
async function testWorkerUpdate() {
    ...
    console.log('Created Worker Keys:', Object.keys(worker));
    ...
    const updateRes = await fetch(`${BASE_URL}/workers`, {
        ...
        body: JSON.stringify({
            id: worker.id,
            name: 'Test Worker Updated Local',
            role: 'Mason',
            teamId: null,
    ...
    if (!updateRes.ok) {
        ...
        console.log('Updated Worker Keys:', Object.keys(updatedWorker));
    }
